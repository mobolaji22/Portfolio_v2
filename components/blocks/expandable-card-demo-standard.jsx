            ...
            <div className="flex gap-4 items-center">
              <motion.div layoutId={`image-${card.title}-${id}`}>
                <Image
                  ...
                  src={card.src}
                  alt={card.title}
                  className="md:h-40 md:w-40 h-14 w-14 rounded-lg object-cover object-top"
                />
              </motion.div>
              <div className="">
                <motion.h3
...
const cards = [
  {
    ...
    content: () => {
      return (
        <p>
          Frontend development is constantly evolving, with numerous frameworks
          and libraries available to developers. Among the most popular are
          React and Vue.js, each offering unique features and advantages. In
          this article, we’ll compare React and Vue.js, exploring their
          differences, strengths, and what makes them suitable for different
          types of projects. We’ll also discuss what I expect to do in the HNG
          Internship and how I feel about using React.
        </p>
      );
    },
  },
